...
def inference(images, is_train=False, should_summarize=True):
    ...
    # conv layers weights
    conv_weights=[64, 64, 64, 128, 128, 128, 128, 128, 128, 256, 256, 256]
    conv_stdevs=[common_stdev] * 12
    conv_weight_decays=[common_decay] * 12
    conv_types= [3]*12
    # dropout_rates=[0.99, 0.9, 0.9, 0.8, 0.8, 0.7, 0.7, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5]
    dropout_rates=[1.]*12
